...
function draw() {
  ...
  timer = timer + 1;
  if (timer > 50) {
    bonnie = Math.floor(random(0, 6));
    timer = 0;
  }

  if (bonnie == 5) {
    drawCharacter(330, 350); //cam 5 bonnie
  drawCharacter(710,300)
  }
  if (bonnie == 1) {
  ...
  if (bonnie == 2) {
    drawCharacter(260, 300); //cam 2
  }
  if (bonnie == 3) {
    drawCharacter(310, 300); //cam 3
  }
  if (bonnie == 4) {
    drawCharacter(210, 350); //cam 4
    drawCharacter(100,300)
  }
  if (chica == 5) {
    drawCharacter2(330, 370); // cam 5 chica
  }
  if (chica == 1) {
    drawCharacter2(210, 320); // 1
  }
  if (chica == 2) {
    drawCharacter2(260, 320); //2
  }
  if (chica == 3) {
    drawCharacter2(310, 320); //3
  }
