...
function draw() {
  ...
  text("p.s don't make your speed -3", 243,102)
      textSize(16)
  text("EVER ", 243,120)
  textSize(17);
...
if (Bob_Tushaar){
 ...
 if (Bob_oops){
  ...
  if (bob_y > 399) bob_y = 0;
  if (bob_y < -2) bob_y = 398;
  if (bob_score > 975) bob_y = bob_y + 4;
  if (bob_score > 1975) bob_y = bob_y + 5;
  if (bob_score > 2975) bob_y = bob_y + 5;
  if (bob_score > 3975) bob_y = bob_y + 5;
  if (bob_score > 4975) bob_y = bob_y + 5;
