...
function draw() {
  ...
  //doughnut
  fill(220, 180, 150);
  ellipse(150 + doughnut, 250, 200);
  fill(220, 199, 255);
  ellipse(150 + doughnut, 250, 100);
  if (doughnut > 1000) {
    fill(0, 0, 255);
  }
  fill(220, 180, 150);
  rect(180 + doughnut, 335, 9, 100);
  rect(130 + doughnut, 335, 9, 100);
  fill(200, 190, 0);
  ellipse(20, 50, 200, 200);
  line(220 + doughnut, 190, 180 + doughnut, 190);
  ...
  if (doughnut > 66 && doughnut < 306 && ball1 > 160 && ball1 < 300) {
    doughnut = 0;
    textSize(150);
    text("HIT!!", 500, 300);
    score = score - 1;
  ...
  textSize(150);
  if (doughnut > 432 && doughnut < 675 && ball2 > 160 && ball2 < 300) {
    doughnut = 0;
    text("HIT!!", 500, 300);
    score = score - 1;
  }
