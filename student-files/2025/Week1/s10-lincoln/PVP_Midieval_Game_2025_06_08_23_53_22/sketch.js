...
function draw() {
  ...
  if(attack1==1 && player1_x+40>player2_x && player1_x+9<player2_x+17 && dmg1==100){
   player2_Health=player2_Health-5
   dmg1=0
}
  //player2 sword damage
  if(attack2==1 && player2_x-27<player1_x+17 && player2_x+17>player1_x+17 && dmg2==100){
  player1_Health=player1_Health-5
  dmg2=0
}
  //omega sword damage
  if(attack1==3 && player1_x+50>player2_x && player1_x+16<player2_x+17 && dmg1>75){
  ...
  stroke("black")
  fill("red")
  text(floor(player1_Health),150,300)
  text('Player 1 Health:',115,285)
  text(floor(player2_Health),750,300)
  ...
  stroke("black")
  textSize(20)
  text("ATTACK METER",50,100)
  text("ATTACK METER",750,100)
  text(floor(dmg1),100,120)
  text(floor(dmg2),800,120)
  //cooldown timer
  dmg1=dmg1+1
  dmg2=dmg2+1
  if(dmg1>100){
