...
function draw() {
  ...
  fill('yellow')
  triangle(700-offset,0,600-offset,100,750-offset, 100)
  fill('orange')
  triangle(700,0+offset,600,100+offset,750, 100+offset)
  fill('rgb(11,173,11)')
  triangle(700-offset,0+offset,600-offset,100+offset,750-offset, 100+offset)
