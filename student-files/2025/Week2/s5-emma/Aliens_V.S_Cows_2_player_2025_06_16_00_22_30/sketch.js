...
function draw() {
  ...
  fill('rgb(7,213,7)')
  text('your can use your beem l',550,150)
  ...
  if (cowscore > 10) {
    ...
    fill("rgb(7,213,7)");
    text("You can now use astroids h,j,k", 500, 200);
    text("And you cant use your beem", 500, 250);

    if (cowX > 350 && cowX < 450 && astroidY1 > cowY && astroidY1 < cowY + 75) {
      alienscore = alienscore + 1;
      cowX = 100;
    }

    if (cowX > 100 && cowX < 200 && astroidY2 > cowY && astroidY2 < cowY + 75) {
      alienscore = alienscore + 1;
      cowX = 100;
    }

    if (cowX > 600 && cowX < 700 && astroidY3 > cowY && astroidY3 < cowY + 75) {
      alienscore = alienscore + 1;
      cowX = 100;
    }
  }
