...
function draw() {
  ...
  line(100, 550, tlaserX, tlaserY)
  line(700, 550, tlaserX2, tlaserY2)
  strokeWeight(1)
  laserY=laserY-30
  noStroke()
  rect(ax, ay, 20, 20)
  ...
  if(ax<400 && ay>400 && unlockexist1>1){
    tlaserX=ax
    tlaserY=ay
  }
  if(ax<400 && ay>400 && unlockexist2>1){
    laserX2=ax
    laserY2=ay
    
  }
  if(bx<400 && by>400 && unlockexist2>1){
    laserX2=bx
    laserY2=by
  }
  if(cx<400 && cy>400 && unlockexist2>1){
    laserX2=cx
    laserY2=cy
  }
  
  
  if(ay>500 && tlaserX==ax && tlaserY==ay){
    
    tlaserX=100
    tlaserY=550
    ay=-50
    ax=random(200, 600)
    points=points+tlevel1
  }
  if(by>500 && tlaserX==bx && tlaserY==by){
    tlaserX2=700
    tlaserY2=550
    by=-50
    bx=random(200, 600)
    points=points+tlevel2
  }
  if(cy>500 && tlaserX==cx && tlaserY==cy){
    tlaserX2=700
    tlaserY2=550
    cy=-50
    cx=random(200, 600)
  ...
  if(ay>500 && tlaserX2==ax && tlaserY2==ay){
    tlaserX2=700
    tlaserY2=550
    ay=-50
    ax=random(200, 600)
  ...
  if(by>500 && tlaserX2==ax && tlaserY2==by){
    tlaserX2=700
    tlaserY2=550
    by=-50
    bx=random(200, 600)
  ...
  if(cy>500 && tlaserX2==ax && tlaserY2==cy){
    tlaserX2=700
    tlaserY2=550
    cy=-50
    cx=random(200, 600)
